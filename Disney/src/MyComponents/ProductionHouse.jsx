  ...
  return (
    <div className='flex gap-2 md:gap-5 p-2 px-5 md:px-16 py-4'>
        {productionHouseList.map((item) => (
            ...
            <div className='group border-[0.5px] md:border-[3px] border-gray-600 rounded-lg overflow-hidden hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer relative shadow-xl shadow-black' key={item.id}>
